...
#for understanding what is the naive_bayes classifier and its usage at high level , please go through below youtube video
#https://www.youtube.com/watch?v=CPqOCI0ahss&list=PL_Nji0JOuXg2udXfS6nhK3CkIYLDtHNLp&index=8
def train:
  total = 0
  numSpam = 0
